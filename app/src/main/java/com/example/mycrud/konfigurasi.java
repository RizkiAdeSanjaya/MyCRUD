...
public class konfigurasi {
    ...
    public static final String URL_GET_ALL = "http://192.168.1.11/Android/pegawai/tampilSemuaPgw.php";
    public static final String URL_GET_EMP = "http://192.168.1.11/Android/pegawai/tampilPgw.php?id=";
